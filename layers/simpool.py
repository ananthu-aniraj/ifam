# Description: This file contains the implementation of the SimPool layer from the paper "Keep It SimPool: Who Said Supervised Transformers Suffer from Attention Deficit?" by Bill Psomas et al.
# Reference: https://github.com/billpsomas/simpool/blob/master/sp.py
import torch
import torch.nn as nn


class SimPool(nn.Module):
    def __init__(self, dim, num_heads=1, qkv_bias=False, qk_scale=None, gamma=1.5, use_beta=True):
        super().__init__()
    ...
    def forward(self, x, attn_mask=None):
        ...
        attn = (qq @ kk.transpose(-2, -1)) * self.scale  # (B, num_heads, Nq, Nk)

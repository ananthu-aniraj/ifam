...
def gumbel_softmax_straight_through_custom(logits: Tensor, tau: float = 1, dim: int = 1, part_dropout: float = 0.0,
                                           training_mode: bool = False) -> Tensor:
    # Ref: https://pytorch.org/docs/stable/_modules/torch/nn/functional.html#gumbel_softmax
    gumbels = (

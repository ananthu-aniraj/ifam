...
class AttnMaskViTDecoupled(torch.nn.Module):
...
def test_attn_mask_vit_decoupled():
    ...
    model = AttnMaskViTDecoupled(dinov2_vits14, num_classes=1000)
    model.to(device)

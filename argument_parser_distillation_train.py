...
def parse_args():
    ...
    parser.add_argument('--pooling_type', default='avg_pool', type=str,
                        choices=['sim_pool', 'max_pool', 'avg_pool',
                                 'attention_pool_latent'])
    ...
    parser.add_argument('--pdisco_image_size', default=518, type=int)
